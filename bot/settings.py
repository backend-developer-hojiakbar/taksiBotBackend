...
SECRET_KEY = 'django-insecure-6l)u#%gtmj4oer+o%i25nab_&5%@bn#5h-ypv(7_9x^z=w!_wf'
...
CORS_ALLOWED_ORIGINS = [
    'https://taksi-bot-front-mqr3.vercel.app',
    'http://127.0.0.1:8000',
]
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to booking!",

    # Copyright on the footer
    "copyright": "booking contributors",
